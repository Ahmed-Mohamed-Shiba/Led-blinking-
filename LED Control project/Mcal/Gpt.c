...
{
	TIMER_RCGCTIMER_REG = 0x01;
	uint32 Timer_Value = 15999 *Timer_Tick;
	TIMER0_GPTMCTL_REG	|= (0x0101);
	
	TIMER0_GPTMCTL_REG	&= ~(0x0101);
	TIMER0_GPTMCFG_REG &= ~(0x07);
	TIMER0_GPTMTAMR_REG = 0x01;
//	TIMER0_GPTMTBMR_REG = 0x01;
	TIMER0_GPTMTAILR_REG = Timer_Value;
//	TIMER0_GPTMTBILR_REG = (Timer_Value >> 16);
	TIMER0_GPTMICR_REG = 0x01;
	TIMER0_GPTMIMR_REG = 0x01;
